    ...
    <ol>
         ...
         <li>
             ...
             <div>
                 ...
                 <label for="question-2-answers-B">B) Web Wide World</label>
             </div>
             
             <div>
                 <input type="radio" name="question-2-answers" id="question-2-answers-C" value="C" />
                 <label for="question-2-answers-C">C) Web for the world </label>
             </div>
     ...
     <li>
        ...
        <h3>Who`s parents did Bucki (The winter soldier) kill ?</h3>
